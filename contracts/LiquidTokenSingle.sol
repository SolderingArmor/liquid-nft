...
contract LiquidTokenSingle is ILiquidToken, IBase
{
    ...
    //========================================
    //
    function calculateFutureTokenAddress(uint256 printID) private inline view returns (address, TvmCell)
    {
    ...
    function printCopy(address targetOwnerAddress) external override onlyOwner reserve
    {
        ...
        _printSupply += 1;
        (address addr, TvmCell stateInit) = calculateFutureTokenAddress(_printSupply);
