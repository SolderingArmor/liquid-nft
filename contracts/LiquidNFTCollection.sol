...
{    //========================================
    ...
    //========================================
    //
    function createEmptyNFT(uint256 uploaderPubkey) external onlyOwner isSealed reserve returns (address)
    {
        (address tokenAddress, TvmCell stateInit) = calculateFutureNFTAddress(_tokensIssued);
